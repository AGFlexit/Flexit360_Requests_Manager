...
Public Class SplashScreenFinal
    Sub New()
        ...
        My.Settings.Item("DB_Connection") = If(UCase(Environment.UserName) = "HELLF",
            "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=I:\Shared drives\Flexit360 Apps (Alain)\Access DBs\Backups\Tests_Dev\20240125.190013.Prod_Support_Issue_Tracking_be.accdb",
