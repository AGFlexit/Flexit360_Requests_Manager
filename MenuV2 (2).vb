...
Partial Public Class MenuV2
    ...
    Private Sub RepositoryItemRichTextEdit1_EditValueChanged(sender As Object, e As EventArgs) Handles RepoRichText.EditValueChanged
        'Me.RepositoryItemRichTextEdit1.DocumentFormat
        Me.RepoRichText.ConvertEditValueToPlainText(Me.RepoRichText.ToString)
    End Sub
...
#End Region
    ...
    Private Sub issuesBindingSource_ListChanged(sender As Object, e As ListChangedEventArgs) Handles issuesBindingSource.ListChanged
