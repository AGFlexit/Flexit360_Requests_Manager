...
Public NotInheritable Class SplashScreen
    ...
    Private Sub SplashScreen_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If UCase(Environment.UserName) = "HELLF" Then
            My.Settings.Item("DB_Connection") = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=I:\Shared drives\Flexit360 Apps (Alain)\Access DBs\Backups\Tests_Dev\20230403.202122.Prod_Support_Issue_Tracking_be.accdb"
        Else
