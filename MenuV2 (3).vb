...
Partial Public Class MenuV2
    ...
    Private Sub navBarControl_ActiveGroupChanged(ByVal sender As Object, ByVal e As DevExpress.XtraNavBar.NavBarGroupEventArgs) Handles navBarControl.ActiveGroupChanged
        Select Case e.Group.Name
            Case "RequestsNavBarGroup"
                ...
                Me.BarToggleSwitchPreview.Checked = Me.GridView1.OptionsView.ShowPreview = True
    ...
    Private Sub MenuV2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'TODO: This line of code loads data into the 'ProdSupport_DataSet.FLEXSMgmt' table. You can move, or remove it, as needed.
        'Me.FLEXSMgmtTableAdapter.Fill(Me.ProdSupport_DataSet.FLEXSMgmt)
        LoadDataAsync()
    End Sub
    ...
    Private Sub LoadDataAsync()
        ...
        Telerik.WinControls.UI.RadOverlayManager.Show(GridControl1)
...
#End Region
    ...
    Private Sub navBarControl_LinkClicked(sender As Object, e As DevExpress.XtraNavBar.NavBarLinkEventArgs) Handles navBarControl.LinkClicked
        If e.Link.Caption = "JIRA Sync" And Me.navigationFrame.SelectedPage IsNot Me.JIRASyncNavigationPage Then Me.NavBarJIRASync.Enabled = False
        Select Case e.Link.Group.Name
            Case "DefectsNavBarGroup"
                Select Case e.Link.Caption
                    Case Me.NavBarJIRASync.Caption 'JIRA Sync
                        If e.Link.Caption = "JIRA Sync" Then
                            If navigationFrame.SelectedPage IsNot Me.JIRASyncNavigationPage Then
                                navigationFrame.SelectedPage = Me.JIRASyncNavigationPage
                                'Me.NavBarJIRASync.Enabled = False
                            End If
                        Else
                            If navigationFrame.SelectedPage IsNot Me.DefectsNavigationPage Then
                                navigationFrame.SelectedPage = Me.DefectsNavigationPage
                                'Me.NavBarJIRASync.Enabled = True
                            End If
                        End If
                    Case Me.NavBarFLEXSDone.Caption
                    ...
                    Case Me.NavBarDefects.Caption 'Active Defects
                    ...
                    Case Me.NavBarEnh.Caption 'Enhancements
            ...
            Case "RequestsNavBarGroup"
                If navigationFrame.SelectedPage IsNot Me.RequestsNavigationPage Then navigationFrame.SelectedPage = Me.RequestsNavigationPage
                Select Case e.Link.Caption
                    ...
                    Case Me.NavBarAllRequests.Caption
                        IssuesTableAdapter1.FillByAll(ProdSupport_DataSet1.Issues)
                        issuesBindingSource.RemoveFilter()
                    Case Me.NavBarAssignedMe.Caption
                    ...
                    Case Me.NavBarUnresolved.Caption
    ...
    Private Sub btnSearchFLEXS_Click(sender As Object, e As EventArgs) Handles btnSearchFLEXS.Click
        ...
        Me.GridControl3.RefreshDataSource()
        Me.GridView16.RefreshData()

        For Each gridColumn As DevExpress.XtraGrid.Columns.GridColumn In GridView16.Columns
    ...
    Private Sub Initialize_DGView()
        If GridControl3.DataSource Is Nothing Then
            Telerik.WinControls.UI.RadOverlayManager.Show(Me.GridControl3)
        ...
        GridControl3.DataSource = JIRAdataTable
